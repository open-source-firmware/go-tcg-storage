...
var (
	...
	Admin_C_PIN_User1Row    RowUID = Admin_C_PINTable.Row([4]byte{0x00, 0x03, 0x00, 0x01})
	Admin_C_PIN_User2Row    RowUID = Admin_C_PINTable.Row([4]byte{0x00, 0x03, 0x00, 0x02})
	...
	LockingSecretProtect_128 RowUID = [8]byte{0x00, 0x00, 0x00, 0x1D, 0x00, 0x00, 0x00, 0x1D}
	LockingSecretProtect_256 RowUID = [8]byte{0x00, 0x00, 0x00, 0x1D, 0x00, 0x00, 0x00, 0x1E}

	GlobalLockingRange RowUID = [8]byte{0x00, 0x00, 0x08, 0x02, 0x00, 0x00, 0x00, 0x01}
